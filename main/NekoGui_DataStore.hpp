...
namespace NekoGui {
    ...
    public:
        ...
        int auto_ping_interval = 0;

        // Security
        bool skip_cert = false;
        QString utlsFingerprint = "";
        bool block_ads_malware = false;
        ...
        // Ping Test / Auto-Check Settings
        bool auto_ping_enabled = false;
        bool auto_ping_include_multi = false;
        QStringList auto_ping_selected_servers;
        int auto_ping_interval_type = 0;
        bool auto_ping_check_all = false;
        int auto_ping_type_all = 0;
        int auto_ping_type_selected = 0;

        // Tor Mode
        bool tor_system_proxy = false;
        bool tor_tun_mode = false;
