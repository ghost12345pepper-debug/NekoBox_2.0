...
namespace NekoGui {
    ...
    DataStore::DataStore() : JsonStore() {
        ...
        _add(new configItem("auto_ping_interval", &auto_ping_interval, itemType::integer));
        ...
        _add(new configItem("auto_ping_enabled", &auto_ping_enabled, itemType::boolean));
        _add(new configItem("auto_ping_include_multi", &auto_ping_include_multi, itemType::boolean));
        _add(new configItem("auto_ping_selected_servers", &auto_ping_selected_servers, itemType::stringList));
        _add(new configItem("auto_ping_interval_type", &auto_ping_interval_type, itemType::integer));
        _add(new configItem("auto_ping_check_all", &auto_ping_check_all, itemType::boolean));
        _add(new configItem("auto_ping_type_all", &auto_ping_type_all, itemType::integer));
        _add(new configItem("auto_ping_type_selected", &auto_ping_type_selected, itemType::integer));

        _add(new configItem("block_ads_malware", &block_ads_malware, itemType::boolean));

        _add(new configItem("tor_system_proxy", &tor_system_proxy, itemType::boolean));
        _add(new configItem("tor_tun_mode", &tor_tun_mode, itemType::boolean));
    }
